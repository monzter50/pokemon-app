        ...
        return(
            <>
                 <div className={`banner type--${type[0]}`}>
                    <NavLink  to={{ pathname: `/`}} className={"banner-self-left text-white"} >Back</NavLink >
                     <div className="avatar-primary">
                        <img src={`https://img.pokemondb.net/artwork/${location.state.name}.jpg`} alt=""/>
                     </div>
                    ...
                    <div className="measurements">
                        ...
                        <div className="measurements-container">
                            ...
                            <div className="measurements-teams">
                                <img src={`${url}${details[name].id}.png?raw=true`} 
                                // style={
                            ...
                            <article className="measurements-details">
                                ...
                                <div>
                                    ...
                                    <small>Note: Image depiction might be inaccurate (trainer has base height of 1.5m)</small>
                                </div>
                            </article>
                        </div>
                    </div>
